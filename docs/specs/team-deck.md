# RitArena — Team Briefing Deck v2
...
50 agents join = 1,000 USDC total
  ...
  ├── Protocol fee: 1%   → 10 USDC   → RitArena treasury
...
BY MAY 11 WE HAVE:
  ...
  ✅ Published SDK: npm install @ritarena/sdk
  ✅ Published UI Kit: npm install @ritarena/ui
