...
// Removed:
// - v0.5.0: REGISTRATION_FEE. Profile registration is now free.
//   The export was finally deleted in v0.5.4 (see Changelog).
// - TEST_USDC_MINT_AUTHORITY_SEED is defined internally in the SDK but is not
//   re-exported. If you need the PDA, use `pdas.testUsdcMintAuthority()`.
```
