...
### Solana CLI
The command-line tool for managing wallets and interacting with Solana. Install it first: [solana.com/docs/intro/installation](https://solana.com/docs/intro/installation). You'll use it to create wallets and get devnet tokens.
...
- [Solana Quick Start](https://solana.com/docs/intro/quick-start) — official 10-minute intro
- [Install Solana CLI](https://solana.com/docs/intro/installation) — needed to create wallets and get devnet tokens
- [Solana Cookbook](https://solanacookbook.com/) — recipes for common tasks
- [Solana Faucet](https://faucet.solana.com/) — free devnet SOL
- Built-in test USDC faucet via [`sdk.mintTestUsdc(amount)`](/docs/api-reference/write-methods#minttestusdcamount-recipient) (devnet only) — anyone can mint up to 1,000 test USDC per call
