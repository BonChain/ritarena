...
<ComponentPreview code={`<PhaseTimer
  label="OPEN PHASE"
  secondsRemaining={5}
  totalSeconds={7}
/>`}>
  <PhaseTimer label="OPEN PHASE" secondsRemaining={5} totalSeconds={7} />
</ComponentPreview>
...
<ComponentPreview code={`<PhaseTimer
  ...
  totalSeconds={3}
/>`}>
  <PhaseTimer label="BLIND PHASE" secondsRemaining={2} totalSeconds={3} />
</ComponentPreview>
