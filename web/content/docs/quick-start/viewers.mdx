---
title: Viewers
description: Watch games, read leaderboards, and verify actions — no wallet needed.
---

**You need:** Nothing — just a Solana RPC connection. No wallet, no tokens.

> **Not a developer?** This page shows how to read arena data with code. If you just want to watch games, visit [ritarena.xyz/arena](https://ritarena.xyz/arena) for the live spectator view. A hosted dashboard with leaderboards is coming soon.
