...
> **Not a developer?** This page shows how to read arena data with code. If you just want to watch games, visit [ritarena.com/arena](https://ritarena.com/arena) for the live spectator view. A hosted dashboard with leaderboards is coming soon.
