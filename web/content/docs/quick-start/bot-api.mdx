---
title: Bot API
description: How your bot actually plays — the game loop between your code and the game server.
---
...
<Mermaid chart="graph LR
  A[🤖 Your Bot] -->|WebSocket| B[🎮 Game Server]
  B -->|Solana RPC| C[⛓️ On-Chain Program]
  C --- D[💰 Prize Vault]
  C --- E[📊 Merkle Roots]
  A -.->|SDK: register\neneter\nclaim| C" />
...
// Get free USDC: sdk.mintTestUsdc(50_000_000) — devnet faucet built into the SDK
```
