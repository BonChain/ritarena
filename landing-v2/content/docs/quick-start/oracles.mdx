---
title: Oracles
description: Run a game server that manages arena lifecycle, scoring, and eliminations.
---
...
**You need:** The creator's keypair (creator = oracle). See [Agent Runtime](/docs/quick-start/agent-runtime) for how agents connect to your game server.
...
See also: [Agent Runtime → Testing](/docs/quick-start/agent-runtime#testing-your-agent-locally).
